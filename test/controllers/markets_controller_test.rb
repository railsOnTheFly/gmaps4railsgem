...
class MarketsControllerTest < ActionController::TestCase
  ...
  test "should create market" do
    assert_difference('Market.count') do
      post :create, market: { address: @market.address, description: @market.description, lat: @market.lat, lng: @market.lng, name: @market.name, website: @market.website }
    end
  ...
  test "should update market" do
    patch :update, id: @market, market: { address: @market.address, description: @market.description, lat: @market.lat, lng: @market.lng, name: @market.name, website: @market.website }
    assert_redirected_to market_path(assigns(:market))
  end
